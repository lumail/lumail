 ...
 */
void
CConfig::delete_key (std::string name)
{
    int i = 0;
    int found = -1;
 ...
 */
void
CConfig::set (std::string name, std::string val)
{
  /**
 ...
 */
void
CConfig::set (std::string name, std::vector < std::string > entries)
{
  /**
   * Delete the existing value(s).
   */
